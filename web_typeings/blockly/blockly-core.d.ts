...
declare namespace Blockly {
  ...
  class Block__Class {
    ...
    dispose(
      healStack: boolean,
      animate: boolean,
      opt_dontRemoveFromWorkspace?: boolean
    ): void;
    ...
    setPreviousStatement(
      newBoolean: boolean,
      opt_check: string | string[] | any /*null*/ | any /*undefined*/
    ): void;
...
declare namespace Blockly.BlockSvg.disconnectUiStop_ {
  /**
...
declare namespace Blockly {
  ...
  function longStart_(
    e: Event,
    uiObject: Blockly.Block | Blockly.WorkspaceSvg
  ): void;
...
declare namespace Blockly.Blocks {
  const loops: any;
  const texts: any;
...
declare namespace Blockly {
  ...
  class FieldDropdown__Class extends Blockly.Field__Class {
     ...
     */
    constructor(
      menuGenerator: string[][] | Function,
      opt_changeHandler?: Function
    );
...
declare namespace Blockly.Flyout {
  /**
   * Stop binding to the global mouseup and mousemove events.
   * @private
   */
...
declare namespace Blockly.Realtime {
  /**
   ...
   * @private
   */
  function placeBlockOnWorkspace_(
    block: Blockly.Block,
    addToTop: boolean
  ): void;
   ...
   * @private
   */
  function onCollaboratorJoined_(
    event: gapi.drive.realtime.CollaboratorJoinedEvent
  ): void;
   ...
   * @private
   */
  function onCollaboratorLeft_(
    event: gapi.drive.realtime.CollaboratorLeftEvent
  ): void;
...
declare namespace Blockly.Toolbox.TreeSeparator {
  /**
...
declare namespace Blockly {
  ...
  function createSvgElement(
    ...
    attrs: Object,
    parent: Element,
    opt_workspace?: Blockly.Workspace
  ): SVGElement;
...
declare namespace Blockly.bindEvent_ {
  /**
...
declare namespace Blockly.fireUiEvent {
  /**
...
declare namespace Blockly.getRelativeXY_ {
  /**
...
declare namespace Blockly.Warning {
  /**
...
declare namespace Blockly.WidgetDiv {
  ...
  function position(
    anchorX: number,
    anchorY: number,
    windowSize: goog.math.Size,
    scrollOffset: goog.math.Coordinate,
    rtl: boolean
  ): void;
}
